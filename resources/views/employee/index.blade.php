        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white p-2 shadow-sm sm:rounded-lg">
                <div class="flex justify-between">
                    <h1 class="mt-3 text-[1.5rem] font-bold leading-[4rem] tracking-tight text-black">Employee List</h1>
                        ...
                        @foreach ($employees as $employee)
                            <tr>
                                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                    <p class="whitespace-no-wrap text-gray-900">{{ $employee->first_name }}</p>
                                </td>
                                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                ...
                                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                    <span
                                        ...
                                        <span class="relative">{{ $employee->created_at }}</span>
                                    </span>
                                </td>
